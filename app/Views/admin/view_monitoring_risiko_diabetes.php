...
<!--begin::Head-->
<head>
	<title>Apadok - Risiko Diabetes</title>
					...
					<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
						<div class="col-md-3">
							...
							<div class="page-title d-flex flex-column me-3">
								<!--begin::Title-->
								<h1 class="d-flex text-dark fw-bolder my-1 fs-3">Monitoring Risiko Diabetes</h1>
								<!--end::Title-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
									...
									<!--end::Item-->
									<!--begin::Item-->
									<li class="breadcrumb-item text-gray-600">Risiko Dibetes</li>
									<!--end::Item-->
								</ul>
								<!--end::Breadcrumb-->
							</div>
						...
						<div class="row" style="--bs-gutter-x: 0;">
							<div class="card card-bordered" style="margin-bottom: 30px">
								<div class="card-header">
									<h3 class="card-title">Grafik Risiko Diabetes</h3>
								</div>
								<!--begin::Card header-->
									...
									<!-- <div class="card-title"> -->
										<!-- <div class="fv-row mb-7"> -->
											...
											<!-- <select name="jenis_kelamin" id="jenis_kelamin" data-control="select2" data-placeholder="Grafik Berdasarkan" data-hide-search="true" class="form-select form-select-solid fw-bolder">
												...
												<option value="obat_hipertensi">Obat Hipertensi</option>
												<option value="obat_hipertensi">Keturunan</option>
											</select> -->
											<!--end::Input-->
										<!-- </div> -->
								...
								<div class="card overflow-hidden mb-5 mb-xl-10">
									...
									<div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
										...
										<div class="mb-4 px-9">
											...
											<!--end::Info-->
											<!--begin::Description-->
											<span class="fs-6 fw-bold text-gray-400 textRisiko">Risiko Sangat Tinggi</span>
											<!--end::Description-->
										</div>
										<!--end::Statistics-->
									</div>
								...
								<div class="card overflow-hidden mb-5 mb-xl-10">
									...
									<div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
										...
										<div class="mb-4 px-9">
											...
											<!--end::Info-->
											<!--begin::Description-->
											<span class="fs-6 fw-bold text-gray-400 textRisiko" style="cursor: pointer">Risiko Sedang</span>
											<!--end::Description-->
										</div>
										<!--end::Statistics-->
									</div>
