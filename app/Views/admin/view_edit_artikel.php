...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-enabled">
			...
			<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
						<div class="col-md-3">
							...
							<div class="page-title d-flex flex-column me-3">
								<!--begin::Title-->
								<h1 class="d-flex text-dark fw-bolder my-1 fs-3">Edit Artikel</h1>
								<!--end::Title-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
									...
									<!--end::Item-->
									<!--begin::Item-->
									<li class="breadcrumb-item text-gray-600">Edit Artikel</li>
									<!--end::Item-->
								</ul>
								<!--end::Breadcrumb-->
							</div>
				...
				<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
					...
					<div class="content flex-row-fluid" id="kt_content">
						...
						<div class="card">
							<!--begin::Card body-->
							<form class="form" id="kt_artikel_add_form" method="post" action="<?= site_url('Artikel/update') ?>" enctype="multipart/form-data">
								<div class="card-body py-4">
									<div class="fv-row mb-7">
										...
										<!--end::Label-->
										<!--begin::Input-->
										<input type="text" name="judul_artikel" id="judul_artikel" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Judul" autocomplete="off" value="<?= $artikel[0]->judul_artikel ?>"/>
										<!--end::Input-->
									</div>
									...
									<div class="videoArtikel">
										<div class="fv-row mb-7">
											...
											<!--end::Label-->
											<input type="text" name="video_artikel" id="video_artikel" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Link">
										</div>
									</div>

									<div class="fv-row mb-7">
										<input type="hidden" name="id_artikel" value="<?= $artikel[0]->id_artikel ?>">
	...
	<script>
		...
		$(document).ready(function(){
			$("#kategori_artikel").select2("val", '<?= $artikel[0]->kategori_artikel ?>');

			var jenis_kategori = '<?= $artikel[0]->jenis_artikel ?>'
			if (jenis_kategori == '1') {
				$("#jenis_text").prop('checked', true);
				$(".videoArtikel").hide();
				var myEditor = document.querySelector('#kt_docs_quill_basic')
				myEditor.children[0].innerHTML = '<?= $artikel[0]->isi_artikel ?>';
			}
			else {
				$("#jenis_video").prop('checked', true);
				$(".textArtikel").hide();
				$("#video_artikel").val('<?= $artikel[0]->isi_artikel ?>');
			}
